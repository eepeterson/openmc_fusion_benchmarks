...
mat1.add_element('Al', 1e-8,    'ao')
mat1.add_element('Nb', 1e-8,    'ao')
mat1.add_element('In', 1e-8,    'ao')
mat1.add_element('Au', 1e-8,    'ao')
mat1.add_element('Fe', 1e-8,    'ao')
mat1.add_element('Zr', 1e-8,    'ao')
mat1.add_element('Ni', 1e-8,    'ao')
mat1.add_element('Ti', 1e-8,    'ao')
mat1.add_nuclide('U235', 1e-8,    'ao')
mat1.add_nuclide('Li6', 1e-8,    'ao')
mat1.add_nuclide('Be9', 1e-8,    'ao')
...
mat2.add_element('Zr', 1e-8,    'ao')
mat2.add_element('Ni', 1e-8,    'ao')
mat2.add_element('Ti', 1e-8,    'ao')
mat2.add_nuclide('U235', 1e-8,    'ao')
mat2.add_nuclide('Li6', 1e-8,    'ao')
...
mat3.add_element('Al', 1e-8,    'ao')
mat3.add_element('Nb', 1e-8,    'ao')
mat3.add_element('In', 1e-8,    'ao')
mat3.add_element('Au', 1e-8,    'ao')
mat3.add_element('Zr', 1e-8,    'ao')
mat3.add_element('Ti', 1e-8,    'ao')
mat3.add_nuclide('U235', 1e-8,    'ao')
mat3.add_nuclide('Li6', 1e-8,    'ao')
...
# 0.0, 480mm, 149.2mm, 250.6mm, 352.0, 455.9mm 
...
tallies = openmc.Tallies([tally_1,tally_2,tally_3,tally_4,tally_5,tally_6,tally_7,tally_8,tally_9,tally_10,tally_11,tally_12,tally_13,tally_14,tally_15,tally_16])
