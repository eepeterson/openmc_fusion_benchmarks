...
for cell_id in [160, 228, 367]:
    ...
    ax0.set_xlim(1e-5, 1e8)
    #ax0.set_ylim(1e3, 1e14)
    ax0.set_xticks(np.logspace(-5,8,14))
    #ax0.set_yticks(np.logspace(3,14,12))
    ...
    ax1.set_ylim(-.1, .1)
    ax1.set_xticks(np.logspace(-5,8,14))
    #ax1.set_yticks(np.logspace(3,14,12))
    ax1.set_xlabel('Energy (eV)')
    ax1.set_ylabel('(OpenMC - MCNP) / MCNP')
