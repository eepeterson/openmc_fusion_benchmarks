...
tally.filters = [detector_cell_filter]
tally.scores = ['(n,2n)', '(n,a)', '(n,p)', '(n,gamma)']
tally.nuclides = ['Nb93', 'Al27', 'Ni58', 'Au197']
# tally.estimator = 'collision'
tallies_file.append(tally)

tally = openmc.Tally(tally_id=102, name='detector_flux')
tally.filters = [detector_cell_filter]
tally.scores = ['flux']
tallies_file.append(tally)
