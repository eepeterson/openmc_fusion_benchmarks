...
act_foil = openmc.Material.mix_materials(
    [nb93, al27, ni58, au197, air, caf2, aisi316], [0, 0, 0, 0.0, 1., 0, 0.], 'vo')
act_foil_box = openmc.Material.mix_materials(
    [nb93, al27, ni58, au197, air, caf2, aisi316], [0, 0, 0, 0.0, 1., 0, 0.], 'vo')

# setting temperatures
# instantiate material collection
materials = openmc.Materials([aisi316, water, copper, air, perspex, ch2,
                             act_foil, concrete, act_foil_box, al27, ni58, nb93, au197, caf2])
...
cell_135 = openmc.Cell(cell_id=135, name='cell_135',
                       fill=act_foil, region=region_135)  # detector
...
cell_158 = openmc.Cell(cell_id=158, name='cell_158',
                       fill=act_foil, region=region_158)  # detector
...
cell_181 = openmc.Cell(cell_id=181, name='cell_181',
                       fill=act_foil, region=region_181)  # detector
...
cell_204 = openmc.Cell(cell_id=204, name='cell_204',
                       fill=act_foil, region=region_204)  # detector
...
cell_239 = openmc.Cell(cell_id=239, name='cell_239',
                       fill=act_foil, region=region_239)  # detector
...
cell_262 = openmc.Cell(cell_id=262, name='cell_262',
                       fill=act_foil, region=region_262)  # detector
...
cell_285 = openmc.Cell(cell_id=285, name='cell_285',
                       fill=act_foil, region=region_285)  # detector
...
cell_308 = openmc.Cell(cell_id=308, name='cell_308',
                       fill=act_foil, region=region_308)  # detector
...
cell_331 = openmc.Cell(cell_id=331, name='cell_331',
                       fill=act_foil, region=region_331)  # detector
...
cell_363 = openmc.Cell(cell_id=363, name='cell_363',
                       fill=act_foil, region=region_363)  # detector
...
cell_386 = openmc.Cell(cell_id=386, name='cell_386',
                       fill=act_foil, region=region_386)  # detector
...
cell_398 = openmc.Cell(cell_id=398, name='cell_398',
                       fill=act_foil, region=region_398)
...
cell_602 = openmc.Cell(cell_id=602, name='cell_602',
                       fill=act_foil_box, region=region_602)  # detector
cell_603 = openmc.Cell(cell_id=603, name='cell_603',
                       fill=act_foil_box, region=region_603)  # detector
cell_604 = openmc.Cell(cell_id=604, name='cell_604',
                       fill=act_foil_box, region=region_604)  # detector
cell_605 = openmc.Cell(cell_id=605, name='cell_605',
                       fill=act_foil_box, region=region_605)  # detector
cell_606 = openmc.Cell(cell_id=606, name='cell_606',
                       fill=act_foil_box, region=region_606)  # detector
cell_607 = openmc.Cell(cell_id=607, name='cell_607',
                       fill=act_foil_box, region=region_607)  # detector
cell_608 = openmc.Cell(cell_id=608, name='cell_608',
                       fill=act_foil_box, region=region_608)  # detector
cell_609 = openmc.Cell(cell_id=609, name='cell_609',
                       fill=act_foil_box, region=region_609)  # detector
cell_610 = openmc.Cell(cell_id=610, name='cell_610',
                       fill=act_foil_box, region=region_610)  # detector
cell_611 = openmc.Cell(cell_id=611, name='cell_611',
                       fill=act_foil_box, region=region_611)  # detector
cell_612 = openmc.Cell(cell_id=612, name='cell_612',
                       fill=act_foil_box, region=region_612)  # detector
...
# universe.plot(basis='xz', width=[40, 40], origin=[0, 0, 0], pixels=[200, 200], color_by='material', colors={
#               air: 'aliceblue', aisi316: 'grey', copper: 'brown', act_foil: 'red', act_foil_box: 'red'})
# plt.grid()
# # plt.savefig("room_xz.png", format="png", dpi=1200)
# plt.show()

# universe.plot(basis='yz', width=[50, 50], origin=[0, 45, 0], pixels=[200, 200], color_by='material', colors={
#               air: 'aliceblue', aisi316: 'grey', copper: 'brown', act_foil: 'red', act_foil_box: 'red'})
# plt.grid()
# # plt.savefig("room_yz.png", format="png", dpi=1200)
# plt.show()

# universe.plot(basis='xy', width=[50, 50], origin=[0, 100, 0], pixels=[200, 200], color_by='material', colors={
#               air: 'aliceblue', aisi316: 'grey', copper: 'brown', act_foil: 'red', act_foil_box: 'red'})
# plt.grid()
# # plt.savefig("room_xy.png", format="png", dpi=1200)


# universe.plot(basis='xy', width=[5, 5], origin=[0, 0, 0], pixels=[200, 200], color_by='material', colors={
#               air: 'aliceblue', aisi316: 'grey', copper: 'brown', act_foil: 'red', act_foil_box: 'red'})
# plt.grid()
# # plt.savefig("room_xy.png", format="png", dpi=1200)
...
# Al27 (n,a) Na23
# dosimetry tallies from IRDFF-II nuclear data library
tally103 = openmc.Tally(tally_id=103, name="al27_irdff_rr")
al27_na_acef = irdff_path + "dos-irdff2-1325.acef"
mt = 107
al27_na_irdff = irdff.cross_section(al27_na_acef, mt)
multiplier = openmc.EnergyFunctionFilter.from_tabulated1d(al27_na_irdff[mt])
tally103.filters = [detector_cell_filter, particle_filter, multiplier]
tally103.scores = ["flux"]

# Ni58 (n,p) Co58
tally104 = openmc.Tally(tally_id=104, name="ni58_irdff_rr")
ni58_np_acef = irdff_path + "dos-irdff2-2825_modified.acef"
mt = 103
ni58_np_irdff = irdff.cross_section(ni58_np_acef, mt)
multiplier = openmc.EnergyFunctionFilter.from_tabulated1d(ni58_np_irdff[mt])
tally104.filters = [detector_cell_filter, particle_filter, multiplier]
tally104.scores = ["flux"]

# Au197 (n,gamma) Au198
tally105 = openmc.Tally(tally_id=105, name="au197_irdff_rr")
...
tally105.filters = [detector_cell_filter, particle_filter, multiplier]
tally105.scores = ["flux"]


tally201 = openmc.Tally(tally_id=201, name='heating_dose')
tally201.filters = [heatdetector_cell_filter, particle_filter]
tally201.scores = ['heating']

# # tally for ww magic
# # mesh filter
# mesh = openmc.RegularMesh()
# mesh.dimension = [200, 200, 200]
# mesh.lower_left = [-620, -810, -456]
# mesh.upper_right = [620, 530, 580]
# mesh_filter = openmc.MeshFilter(mesh)
# # mesh tally - neutron flux
# tally999 = openmc.Tally(tally_id=999, name='tally999')
# tally999.filters = [neutron_filter, mesh_filter]
# tally999.scores = ['flux']


# export
tallies = openmc.Tallies(
    [tally101, tally102, tally103, tally104, tally105, tally201])
...
my_fng_source = fng_source_froutine.fng_source(
    center=fng_center, reference_uvw=fng_uvw)  # from routine

# # import ww from magic:
# settings_ww = openmc.Settings.from_xml('settings_ww.xml')
# ww = settings_ww.weight_windows

# weight windows from wwinps
ww = openmc.wwinp_to_wws(r"fng_str_cadis.cadis.wwinp")
